...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'RgMoviesone@anct.website',
  ...
  footer:
    'Powered by <a href="https://github.com" target="_blank" rel="noopener noreferrer">onedrive-index</a>. Made with ❤ by SaM.',

  // [OPTIONAL] This is where you specify the folders that are password protected. It is an array of paths pointing to all
  // the directories in which you have .password set. Check the documentation for details.
  protectedRoutes: ['/Private', '/private folder/Private Folder Password Rgmovieshfd51cd@#6250.vip'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'RgMoviesone@anct.website',
